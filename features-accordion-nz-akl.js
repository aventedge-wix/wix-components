...
const FEATURES = [
  {
    ...
    image: "https://static.wixstatic.com/media/958742_29733573f1f84bcbb9c1d47cc7ad936c~mv2.jpg",
    speakerBlocks: [
      {
  ...
  },
  {
    ...
    image: "https://static.wixstatic.com/media/958742_56c48a0758f6434993dcd9425759ab32~mv2.jpg",
    speakerBlocks: [],
    subSessions: [
      {
...
class FeaturesAccordionNzAkl extends HTMLElement {
  connectedCallback() {
...
customElements.define("features-accordion-nz-akl", FeaturesAccordionNzAkl);
